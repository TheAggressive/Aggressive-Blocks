...
export const ANIMATION_PRESETS: Record<string, AnimationPreset> = {
  gentleFade: {
    name: __('Gentle Fade', 'aggressive-blocks'),
    description: __('Soft fade-in, safe everywhere', 'aggressive-blocks'),
    attributes: {
      useSequence: false,
      animation: 'fade',
      direction: '',
  ...
  riseUp: {
    name: __('Rise Up', 'aggressive-blocks'),
    description: __('Content slides up as it enters', 'aggressive-blocks'),
    attributes: {
      useSequence: false,
      animation: 'slide',
      direction: 'up',
