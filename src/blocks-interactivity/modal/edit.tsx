      ...
      <div {...blockProps}>
          ...
          <InnerBlocks
            template={[
              [
                ...
                {
                  level: 3,
                  content: __('Modal Title', 'aggressive-blocks'),
                },
              ],
              [
                'core/paragraph',
        ...
        <div className='modal-editor-footer'>
          <div className='modal-editor-footer-item'>
            {__('Position:', 'aggressive-blocks')}{' '}
            {safePosition.charAt(0).toUpperCase() + safePosition.slice(1)}
          </div>

          {openOnLoad && (
            <div className='modal-editor-footer-item'>
              {__('Opens Automatically', 'aggressive-blocks')}
            </div>
          )}

          {disableOverlay && (
            <div className='modal-editor-footer-item'>
              {__('Disabled Overlay', 'aggressive-blocks')}
            </div>
          )}
          ...
          {safeTriggerBlockId ? (
            <div className='modal-editor-footer-item'>
              ...
              {__('Uses Trigger Block', 'aggressive-blocks')}{' '}
            </div>
          ) : (
            <div className='modal-editor-footer-item'>
              {__('Uses Trigger Label', 'aggressive-blocks')}
            </div>
          )}
        </div>
      </div>
